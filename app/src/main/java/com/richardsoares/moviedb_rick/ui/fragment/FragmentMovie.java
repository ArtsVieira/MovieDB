...
public class FragmentMovie extends Fragment implements MovieHorizontalAdapter.onSelectData, MovieAdapter.onSelectData {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rvFilmRecommend.setItemViewCacheSize(20);
    ...
    private void getMovie(int page) {
        ...
        AndroidNetworking.get(ApiMovieDB.BASEURL + ApiMovieDB.MOVIE_POPULAR + ApiMovieDB.APIKEY +
                              ApiMovieDB.LANGUAGE+"&page="+String.valueOf(page))
                .setPriority(Priority.HIGH)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
                    @Override
